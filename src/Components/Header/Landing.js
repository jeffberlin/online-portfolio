        ...
        <Row>
          <Col xl={6} lg={6} md={8} style={{ paddingLeft: '0'}}>
            <div className='name-box'>
              ...
              <p className='roboto' style={{ color: '#fff', letterSpacing: '.5px' }}>I am a highly motivated UI/UX designer and developer with over 8 years of experience. I have worked in many different industries and I love to learn new things and problem solve.</p>
